...
const TestimonialCard: React.FC<{ t: any }> = ({ t }) => (
  <div className="glass-card p-8 w-[350px] sm:w-[400px] flex-shrink-0 mx-4 relative group hover:border-slate-300 transition-all duration-300 bg-white">
    {/* Stars */}
    ...
    <div className="flex items-center gap-4 pt-4 border-t border-slate-100">
      ...
      <div>
        <p className="text-sm font-bold text-slate-900 tracking-tight">{t.name}</p>
...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="section-padding relative overflow-hidden py-24">
      <div className="ambient-blob w-[500px] h-[500px] bg-blue-400/5 -top-20 -right-20" />
      <div className="ambient-blob w-[400px] h-[400px] bg-purple-400/5 bottom-0 left-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 mb-20">
        ...
        >
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full text-[11px] font-bold tracking-widest uppercase border bg-yellow-50 border-yellow-200 text-yellow-600 mb-6 font-sans">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-6 tracking-tight" style={{ color: 'var(--text-primary)' }}>
            Trusted by <span className="gradient-text-blue">500+ Businesses</span>
          </h2>
